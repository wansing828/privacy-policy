...
- No cloud synchronization (iCloud or otherwise) is used.
- No backups are made to remote systems by the app.
...
The app allows you to optionally store payment method identifiers (e.g., partial card numbers or account references). This information is stored locally on your device and is never transmitted externally. You control what information you choose to enter.
...
If this privacy policy is updated, changes will be reflected in this document with an updated date.

## Contact

If you have questions about this privacy policy, please open an issue on the project's repository.
